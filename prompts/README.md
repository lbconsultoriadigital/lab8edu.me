# Prompt Engineering Library / Biblioteca de Engenharia de Prompt
...
Welcome to the **LAB8 Prompt Engineering Library**. This directory contains curated, production-ready system prompts and context frameworks designed for LLMs (Claude, OpenAI, DeepSeek, and open-source models).
...
2. **Explicit Output Format**: Specify JSON schemas, markdown formats, or plain text.
3. **Guardrails**: Define clear constraints to avoid hallucination and ensure factual accuracy.
...
Bem-vindo à **Biblioteca de Engenharia de Prompt da LAB8**. Este diretório reúne system prompts testados e prontos para produção, desenhados para modelos de linguagem avançados (Claude, OpenAI, DeepSeek e modelos abertos).
...
2. **Formato Explícito de Saída**: Especifique schemas JSON, formatos markdown ou texto puro.
3. **Restrições Rígidas**: Defina limites claros para mitigar alucinações e garantir precisão factual.
